...
function Gallery() {
  return (
    <>
        <Heading title="Explore the collection" text="Most of us have a treasured collection at some point of our lives.
         For all the fans of artifacts out there, explore the diversities of how the pure mud could be casted into
         magnificence. Give ample space on your vintage cupboard to arrange our rich artifacts and renovate your
         dream homes with our pretty decors. It’s high time to replace the unscientific culinary tools with pure,
         dressed, finished, dense and solely handmade Mudmoulds."/>
 
         <ImageCard title="MURALS & WALL ARTS"
      ...
      />
      <ImageCard title="INTERIOR DECORS"
        text="Mudmoulds not only has the hands of our artist but also,
         our souls too get mixed with the moulding clay. With the intricate designs and wide array of patterns,
         decorating homes with art of clay has become quite a big mania in modern society. 
         Handmade mudmoulds adds an element of groundedness to a living space. We offer a diverse range of options to choose from, and decorating,
         you are able to customize your look and make your interior as personal as possible."
        image={"images/gallery/gallery2.png"}
        reverse={true}
      />
      <ImageCard title="GARDON DECORS"
        text="Gardening is no more a hobby, but it is a restorative work in building oneself.
         The endangered species of plants can no more cope with conventional mud pots,
         Mudmoulds favors you with the making of outdoor garden and indoor plants unique and in adding a tint of luxury and royalty.
         Explore the novel ideas in garden decorations and own your bespoke mudmould in just a ring. "
        image={"images/gallery/gallery3.png"}
      />
       <ImageCard title="CULINARY TOOLS"
        text="The arena of cooking underwent many explorations and people are pretty much aware about the healthy food style.
        Here we present you the culinary tools with healing aids.
        Adding feather to the crown our culinary tools are durable, fine, free
        from chemical and completely organic and handmade with love and care.
        We care for your health and never would like to compromise the well being of next generation with chemicals oozing out from aluminium and plastic containers."
...
function Gallery() {
  return (
    <div className={styles.container}>
      ...
      <ImageLeftCard
        image="./images/imageCard/galleryMurals.png"
      ...
      />
      <ImageRightCard
        image="./images/imageCard/galleryInteriorDecor.png"
      ...
      />
      <ImageLeftCard
        image="./images/imageCard/galleryGardenDecor.png"
        title="GARDEN DECORS"
      ...
      />
      <ImageRightCard
        image="./images/imageCard/galleryCullinaryTools.png"
